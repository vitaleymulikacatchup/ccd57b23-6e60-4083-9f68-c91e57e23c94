...
export const metadata: Metadata = {
  title: "Grandview Hotel - Luxury 5-Star Accommodations",
  description: "Experience unparalleled luxury at Grandview Hotel. Premium rooms, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodations, premium suites, hotel amenities, fine dining, spa services",
  openGraph: {
    title: "Grandview Hotel - Luxury 5-Star Accommodations",
    description: "Experience unparalleled luxury at Grandview Hotel with premium accommodations and world-class amenities.",
    ...
    images: [{
      ...
      alt: "Grandview Hotel luxury lobby"
    }]
  },
  twitter: {
